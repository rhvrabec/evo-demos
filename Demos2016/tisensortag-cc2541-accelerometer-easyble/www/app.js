...
;(function () {
	...
	app.start = function () {
		...
		evothings.easyble.startScan(function (device) {
			app.showInfo('BLE Found device: ' + device.name + ' ' + JSON.stringify(device.advertisementData));
	...
	app.connectToDevice = function (device) {
		device.connect(app.readServices, app.onError);
	};

	app.readServices = function (device) {
		device.readServices(['f000aa10-0451-4000-b000-000000000000'], app.enableAccelerometer, app.onError);
	};
 ...
 */
	...
	app.enableAccelerometer = function (device) {
		//console.log(JSON.stringify(device, null, 2))

		// Turn on accelerometer.
		device.writeServiceCharacteristic('f000aa10-0451-4000-b000-000000000000', 'f000aa12-0451-4000-b000-000000000000', new Uint8Array([1]), function () {}, app.onError);

		// Set update interval.
		var milliseconds = 100;
		device.writeServiceCharacteristic('f000aa10-0451-4000-b000-000000000000', 'f000aa13-0451-4000-b000-000000000000', new Uint8Array([milliseconds / 10]), function () {}, app.onError);
		/*
  ...
  */
		...
		device.enableServiceNotification('f000aa10-0451-4000-b000-000000000000', 'f000aa11-0451-4000-b000-000000000000', app.onAccelerometerData, app.onError);
  ...
  */
	...
	app.onAccelerometerData = function (data) {
		data = new Uint8Array(data);
		var accelerometer = app.getAccelerometerValues(data);
		app.showInfo('Accelerometer: ' + accelerometer.x + ' ' + accelerometer.y + ' ' + accelerometer.z + ' ');
	};
