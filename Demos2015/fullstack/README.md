...
* Folder "browserlauncher" contains a page that can be opened in a mobile web browser. From there you can open the demo page by the means of a button the goes to an "evothings:" URL. Here is a test page: https://evothings.com/fullstack
